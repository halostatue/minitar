...
* Breaking Changes:
  * Extracted <tt>bin/minitar</tt> into a new gem, <tt>minitar-cli</tt>. No,
    I am *not* going to bump the major version for this. As far as I can tell,
    few people use the command-line utility anyway.
...
* Enhancements:
  ...
  * Modified the handling of +mtime+ in PosixHeader to do an integer conversion
    (<tt>#to_i</tt>) so that a Time object can be used instead of the integer
    value of the time object.
